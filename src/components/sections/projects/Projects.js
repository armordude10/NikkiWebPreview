              ...
              <div className="section__title section__title--2">
                <div className="section__title__heading">
                  <h3 className="mb-0">
                    ...
                    <span className=" text__unerline">ART INC. </span>{" "}
                    & EMPOWERMENT.{" "}
                  </h3>
                </div>
              </div>
            ...
            <div className="row align-items-center">
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                <div className="project__bottom__button">
                  <ButtonPrimary text="EXPLORE ART INC. LEGACY" path="/projects" />
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
              ...
              <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div className="project__bottom__text">
                  <p>
                    Through ART Inc. and transformational speaking engagements, Nikki has empowered thousands to embrace their audacity.{" "}
                    <a href="#">Discover the ripple effects of authentic leadership</a>{" "}
                    and creative empowerment in communities nationwide.
                  </p>
                </div>
              </div>
            </div>
