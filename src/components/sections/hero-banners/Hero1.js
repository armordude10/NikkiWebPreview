...
const Hero1 = () => {
  const slides = [
    {
      title: "AUDACITY IS YOUR BIRTHRIGHT",
      desc: "Transform your power into purpose. Discover the courage to lead, create, and live authentically with visionary leader Nikki Romain.",
      path: "/about",
      img: herobannerImage1,
    },
    {
      title: "THE AUDACITY BLUEPRINT",
      desc: "Unlock your potential with transformational speaking, empowerment coaching, and revolutionary self-discovery tools.",
      path: "/contact",
      img: herobannerImage2,
    },
    {
      title: "RIVETING NIKKI",
      desc: "From performing artist to nonprofit CEO to empowerment speaker - your journey to audacious living starts here.",
      path: "/contact",
