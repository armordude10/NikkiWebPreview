          ...
          >
            <div className="section__title text-center sp_bottom_80">
              ...
              <div className="section__title__heading contact__heading">
                <h3>Start Your Audacious Journey - Let&apos;s Connect.</h3>
              </div>
            </div>
          </div>
          <div
                ...
                <div className="row">
                  ...
                  <div className="col-xl-12">
                    ...
                    >
                      ...
                      <option value="coaching">Empowerment Coaching</option>
          ...
          >
            <div className="contact__info">
              ...
              >
                ...
                <div className="contact__text">
                  <h6>Connect:</h6>
                  <p>speaking@nikkiromain.com</p>
                  <p>hello@rivetingnikki.com</p>
                </div>
              </div>
              ...
              >
                ...
                <div className="contact__text">
                  <h6>Based In:</h6>
                  <p>Peoria, Illinois</p>
                  <p>Serving Nationally & Virtually</p>
                </div>
              </div>
            </div>
            <div
